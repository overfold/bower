          ...
          action={
            <div className="grid w-full grid-cols-1 gap-2 sm:w-auto sm:grid-cols-2">
              ...
              <select
                ...
                className="h-10 w-full appearance-none rounded-lg sm:h-8 sm:w-[140px] border border-line bg-surface px-2.5 pr-8 text-[12.5px] text-ink shadow-card transition-[border-color,box-shadow] duration-150 focus:border-brand-300 focus:outline-none focus:ring-2 focus:ring-brand-100"
                value={envFilter}
